    ...
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    IdentityResult addLoginResult = await UserManager.AddLoginAsync(user.Id, info.Login);
                ...
                else
                {
                    ...
                    //create avatar
                    string defaultavatar = userService.createAvatar(loginInfo.ExternalIdentity.GetUserName());
                    //set new user
